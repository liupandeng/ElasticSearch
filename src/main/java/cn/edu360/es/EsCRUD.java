...
public class EsCRUD {
    ...
    public void init() throws Exception {
        ...
        client = new PreBuiltTransportClient(settings).addTransportAddresses(
                new InetSocketTransportAddress(InetAddress.getByName("192.168.11.211"), 9300),
                new InetSocketTransportAddress(InetAddress.getByName("192.168.11.212"), 9300));
    ...
    public void testDelete() {
        DeleteResponse response = client.prepareDelete("store", "books", "1").get();
    ...
    public void testDeleteByQuery() {
        BulkByScrollResponse response =
                DeleteByQueryAction.INSTANCE.newRequestBuilder(client)
                        //指定查询条件
                        .filter(QueryBuilders.matchQuery("content", "\t\n" +
                                "公安部：各地校车将享最高路权"))
                        //指定索引名称
                        .source("news")
                        .get();
    ...
    /**
     * curl -XPUT 'http://192.168.11.211:9200/player_info/player/1' -d '{ "name": "curry", "age": 29, "salary": 3500,"team": "war", "position": "pg"}'
     * curl -XPUT 'http://192.168.11.211:9200/player_info/player/2' -d '{ "name": "thompson", "age": 26, "salary": 2000,"team": "war", "position": "pg"}'
     * curl -XPUT 'http://192.168.11.211:9200/player_info/player/3' -d '{ "name": "irving", "age": 25, "salary": 2000,"team": "cav", "position": "pg"}'
     * curl -XPUT 'http://192.168.11.211:9200/player_info/player/4' -d '{ "name": "green", "age": 26, "salary": 2000,"team": "war", "position": "pf"}'
     * curl -XPUT 'http://192.168.11.211:9200/player_info/player/5' -d '{ "name": "james", "age": 33, "salary": 4000,"team": "cav", "position": "sf"}'
     */
    @Test
